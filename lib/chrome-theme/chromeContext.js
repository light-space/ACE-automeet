...
const chromeSalesforce = {
  ...
  /* `.slds-scoped-notification_light`: a standing advisory in Lightning is a
     neutral panel with a coloured glyph, not a block of orange. The orange
     block is `.slds-theme_warning`, which is what `Toast` is for. */
  "--chrome-warning-wash": "var(--sf-bg-shade)",
